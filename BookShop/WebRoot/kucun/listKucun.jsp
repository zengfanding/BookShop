...
<body>
	...
	<s:form namespace="/book" action="BookAction_findToKucun">
		...
		<table width="88%" border="0" class="emp_table" style="width:80%;">
			...
			<tr>
				...
				<td>
					<s:a namespace="/book" action="BookAction_findBookWithEmergency">
						<img src="${pageContext.request.contextPath}/images/button/searemergency.gif" />
					</s:a>
	...
	<table width="97%" border="1">
		...
		<tr class="henglan" style="font-weight:bold;">
			...
			<td width="10%" align="center">库存量</td>
		...
		<s:iterator value="#allBookList">
			<tr class="tabtd1">
				...
				<td width="11%" align="center">
					<s:if test="num < 10">
						<s:a namespace="/book" action="BookAction_AddJinshu">
							<img src="${pageContext.request.contextPath}/images/button/emergency.png" class="img" />
	...
	<s:hidden name="emergency" value="%{emergency}" id="emergency"></s:hidden>
</body>
<script type="text/javascript">
	...
	function changePage(num){
		...
		if(emergency == 1){
			...
			document.getElementById("type").value="byEmergency";
