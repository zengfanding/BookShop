...
<body>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="wukuang"
		...
		<tr>
			...
			<td width="39%" align="left">[查询进书单]</td>
	...
	<s:form namespace="/jin" action="JinshuAction_find">
		...
		<table width="88%" border="0" class="emp_table" style="width:80%;">
			<tr>
				<td width="10%">进书码：</td>
				<td width="20%"><s:textfield name="jinshuMa"></s:textfield></td>
				<td ></td>
				<td ></td>
			</tr>
			<tr>
	...
	<table width="97%" border="1">
		...
		<tr class="henglan" style="font-weight:bold;">
			<td width="12%" align="center">进书码</td>
			...
			<td width="10%" align="center">采购量</td>
			<td width="10%" align="center">采购日期</td>
			<td width="11%" align="center">操作</td>
		</tr>
		
		
		<s:iterator value="#allJinshuList">
			<tr class="tabtd1">
				<td align="center"><s:property value="jinshuMa" /></td>
				...
				<td align="center"><s:property value="caiGouNum" /></td>
				
				<s:if test="caiGouDate == null">
					<td align="center"><span><font color = "red">尚未处理</font></span></td>
					<td width="11%" align="center">
					<s:a namespace="/jin" action="JinshuAction_handle">
						<img src="${pageContext.request.contextPath}/images/button/handlejinshu.gif" class="img" />
						<s:param name="bookInfo.bookid" value="bookInfo.bookid"></s:param>
						<s:param name="bookInfo.tiaoma" value="bookInfo.tiaoma"></s:param>
						<s:param name="bookInfo.name" value="bookInfo.name"></s:param>
						<s:param name="bookInfo.num" value="bookInfo.num"></s:param>
						<s:param name="bookInfo.author" value="bookInfo.author"></s:param>
						<s:param name="bookInfo.publishing" value="bookInfo.publishing"></s:param>
						<s:param name="bookInfo.price" value="bookInfo.price"></s:param>
						<s:param name="bookInfo.img" value="bookInfo.img"></s:param>
						<s:param name="jinPrice" value="jinPrice"></s:param>
						<s:param name="caiGouNum" value="caiGouNum"></s:param>
						<s:param name="jinshuMa" value="jinshuMa"></s:param>
						<s:param name="jinhuoId" value="jinhuoId"></s:param>
					</s:a>
