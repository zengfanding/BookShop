...
<script type="text/javascript">
	function modifypsw(){
   		var dw=window.showModalDialog('${pageContext.request.contextPath}/WEB-INF/adminpages/updPwd.jsp','', 'dialogHeight:180px; dialogWidth:260px; dialogLeft:500px; dialogTop:220px;edge:sunken;center:yes;location:no;help:no;resizable:no;status:no;scroll:no');
	} 
</script>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table2">
			<tr>
				...
				<table border="0" width="145" id="table7" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="150" height="35"><p align="right"><font color="#FFFFFF">欢迎您：<s:property value="#session.loginAdminUser.truename"/><b></b></font></td>
					</tr>
				</table>
				</div>
				</td>
						...
						<div align="right">
							<table border="0" width="215" cellspacing="0" cellpadding="0" id="table6" height="23">
								<tr>
									...
									<td width="51" valign="middle"><font color="#FFFFFF"><a href="" ><font color="ffffff">更改口令</font></a></td>
									<td width="31"><p align="center"><img border="0" src="${pageContext.request.contextPath}/images/login.gif"></td>
									<td width="55" valign="middle">
										<s:a namespace="/admin" action="Admin_relogin" target="_top">
										
											<font color="ffffff">重新登录</font>
										</a>
										</s:a>
									</td>
								</tr>
